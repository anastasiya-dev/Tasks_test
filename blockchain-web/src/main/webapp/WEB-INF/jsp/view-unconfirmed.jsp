...
<br>
<br>
<form style="margin-top: 2cm;"  action="/blockchain-web/${userId}/wallet/${walletId}/unconfirmed/delete-all" method="get" >
   ...
   <tbody>
      <c:forEach items="${transactions}" var="transaction">
         <tr>
            ...
            <td>
               <p><a href="/blockchain-web/${userId}/wallet/${walletId}/transaction/${transaction.transactionId}/sign-transaction" class="text-primary">Sign</a></p>
            <td>
            <td>
               <p><a href="/blockchain-web/${userId}/wallet/${walletId}/transaction/${transaction.transactionId}/delete-transaction" class="text-primary">Delete</a></p>
            <td>
         </tr>
      </c:forEach>
   </tbody>
